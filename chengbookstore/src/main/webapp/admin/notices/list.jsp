						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${notices}" var="n">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%"><f:formatDate value="${n.n_time }" type="date"></f:formatDate></td>
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/notice/deleteNoticeServlet.do?id=${n.n_id}">
											<img
					...
					<tr>
						<td style="CURSOR: hand; HEIGHT: 22px" align="center">
							<cheng:pager pageIndex="${pageModel.pageIndex}"
										 ...
										 submitUrl="${pageContext.request.contextPath}/admin/notice/findAllNotices.do?pageIndex={0}"></cheng:pager>
						</td>
					</tr>
			</TBODY>
		</table>
