...
window.onload = function() {	// 页面加载之后, 获取页面中的对象
    ...
    receiveaddressObj = document.getElementById("receiverAddress");
    receivephoneObj= document.getElementById("receiverName");
    receivenameObj= document.getElementById("receiverPhone");

	emailMsg = document.getElementById("emailMsg");
	usernameMsg = document.getElementById("usernameMsg");
	passwordMsg = document.getElementById("passwordMsg");
	confirmMsg = document.getElementById("confirmMsg");
    receiverAddressMsg = document.getElementById("receiverAddressMsg");
    receiverNameMsg = document.getElementById("receiverNameMsg");
    receiverPhoneMsg = document.getElementById("receiverPhoneMsg");
