		...
		<table width="900px" border="0" cellspacing="0">
			<tr>
				...
				<td style="padding:5px 15px 10px 40px">
					...
					<table width="100%" border="0" cellspacing="0">
						<tr>
						<c:forEach items="${products}" var="pArray">
							<td style="width: 80px; text-align:center">
								<a href="${pageContext.request.contextPath}/client/product/findProductById.do?id=${pArray.id}">
									<img src="${pageContext.request.contextPath}${pArray.imgurl}" width="102" height="130" border="0" />
								</a>
								<br /> 
								<a href="${pageContext.request.contextPath}/client/product/findProductById.do?id=${pArray.id}">${pArray.name}</a>
								<%-- <br />作者:${pArray[2] } --%>
							</td>
						</c:forEach>
						</tr>
