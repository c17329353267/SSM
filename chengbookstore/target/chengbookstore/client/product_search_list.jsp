					...
					<table cellspacing="0" class="listcontent">
										...
										<c:forEach items="${products}" var="p" varStatus="vs">
											<td>
												<div class="divbookpic">
													<p>
														<a href="${pageContext.request.contextPath}/client/product/findProductById.do?id=${p.id}"><img
						...
						<td>
							<ccheng:pager pageIndex="${pageModel.pageIndex}"
										  ...
										  submitUrl="${pageContext.request.contextPath}/client/product/findProductByName.do?pageIndex={0}"></ccheng:pager>
						</td>
					</tr>
