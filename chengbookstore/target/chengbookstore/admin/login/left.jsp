...
<div class="dtree">
  ...
  <tr>
  	<%--<td><a href="${pageContext.request.contextPath}/listProduct" target="mainFrame" class="left_list">商品管理</a></td>--%>
        <td><a href="${pageContext.request.contextPath}/admin/products/findProducts.do" target="mainFrame" class="left_list">商品管理</a></td>
  </tr>
  <tr>
...
<%--  	<td><a href="${pageContext.request.contextPath}/findOrders" target="mainFrame" class="left_list">订单管理</a></td>--%>
    <%--<td><a href="${pageContext.request.contextPath}/admin/orders/list.jsp" target="mainFrame" class="left_list">订单管理</a></td>--%>
    <td><a href="${pageContext.request.contextPath}/admin/orders/findAllAdminOrders.do" target="mainFrame" class="left_list">订单管理</a></td>
  </tr>
  <tr>
