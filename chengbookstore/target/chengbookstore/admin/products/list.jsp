...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/products/findProducts.do"
		method="post">
							...
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><select name="category"
									...
									<option value="文学" <c:if test="${product.category} == '文学'">selected</c:if>>文学</option>
										...
										<option value="艺术" <c:if test="${product.category} == '文学'">selected</c:if>>艺术</option>
							...
							<c:forEach items="${ps}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/products/editAndModifyProduct.do?id=${p.id}">
											<img
                ...
                <tr>
                    <td align="center">
                        <cheng:pager pageIndex="${pageModel.pageIndex}"
                                     ...
                                     submitUrl="${pageContext.request.contextPath}/admin/products/findProducts.do?pageIndex={0}"></cheng:pager>
                    </td>
                </tr>
			</TBODY>
