...
<html>
	...
	<script type="text/javascript">
		...
		function modifyJobs() {
            ...
            $.post("${pageContext.request.contextPath}/modifyJobById.do",$("#jobForm").serialize(),
				function (data) {
					alert(data);
					window.location.href = "${pageContext.request.contextPath}/findJobs.do?pageIndex=${pageIndex}";
                }
			);
        }
	 /*$(function(){
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <%--<form action="${pageContext.request.contextPath}/job/updateJob" id="jobForm" method="post">--%>
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="modifyJobs()">&nbsp;&nbsp;<input type="reset" value="取消" onclick="javascript:history.go(-1);location.reload()"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
