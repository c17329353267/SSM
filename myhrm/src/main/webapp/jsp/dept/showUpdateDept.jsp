...
<html>
	...
	<script type="text/javascript">
		...
		function modifyDept() {
            ...
            /*请求路径，序列化成json数据方便controller接收，相应数据*/
            $.post("${pageContext.request.contextPath}/modifyDept.do",
				$("#deptForm").serialize(),function (data) {
					if(data == "OK"){
					    alert("修改成功");
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/dept/updateDept" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
			...
			<tr><td align="left" class="fftd"><input type="button" value="修改" onclick="modifyDept()">&nbsp;&nbsp;<input type="reset" value="取消" onclick="javascript:history.go(-1);location.reload()"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
