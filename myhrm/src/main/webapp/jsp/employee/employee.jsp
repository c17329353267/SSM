	       ...
	       $(function(){
	    	   ...
	    	   $("#delete").click(function(){
	    		   ...
	    		   if(checkedBoxs.length < 1){
	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){//点击确认执行true
	    				   if(r){
	    					   alert("删除："+ids.get());
	    					   // 发送请求
	    					   window.location = "${pageContext.request.contextPath}/removeEmployee.do?ids=" + ids.get();
	    				   }
	    			   });
	    		   }
	    	   })
		    ...
		    <tr>
			  <td class="fftd">
			  	<%--<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/employee/selectEmployee">--%>
					<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/findAllEmployees.do">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	职位：
					    	...
					    	身份证号码：<input type="text" name="cardId" maxlength="18" value="${employee.card_id}">
					    </td>
					  </tr>
					  <tr>
					    <td class="font3">
		  ...
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.employees}" var="employee" varStatus="stat">
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					...
					<td align="center" width="40px;"><a href="${pageContext.request.contextPath}/findEmployeeById.do?id=${employee.id}">
					<%--<td align="center" width="40px;"><a href="${pageContext.request.contextPath}jsp/employee/showUpdateEmployee.jsp">--%>
		...
		<tr>
			...
			<td>
				<cheng:pager pageIndex="${pageModel.pageIndex}"
							 ...
							 submitUrl="${pageContext.request.contextPath}/findAllEmployees.do?pageIndex={0}"></cheng:pager>
			</td>
		</tr>
	</table>
