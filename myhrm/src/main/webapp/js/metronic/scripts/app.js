/**
Core script to controller the entire layout and base functions
**/
var App = function () {
    ...
    var handleResponsive = function () {
        ...
        // controller all elements which require to re-initialize on screen width change(on resize or on rotate mobile device)
    ...
    var handleSidebarToggler = function () {
        ...
        // controller the search bar close
        $('.sidebar-search .remove').click(function (e) {
            $('.sidebar-search').removeClass("open");
            e.preventDefault();
        });

        // controller the search query submit on enter press
    ...
    var handleHorizontalMenu = function () {
        ...
        //controller hor menu search form toggler click
        ...
        //controller hor menu search button click
        $('.header .hor-menu .search-form .btn').live('click', function (e) {
            window.location.href = "extra_search.html";
            e.preventDefault();
        });

        //controller hor menu search form on enter press
    ...
    return {
        ...
        init: function () {
            //core handlers
            handleResponsive(); // set and controller responsive
