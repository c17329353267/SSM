var Inbox = function () {
    ...
    return {
        ...
        init: function () {
            ...
            // controller compose btn click
            $('.inbox .compose-btn a').live('click', function () {
                loadCompose();
            });

            // controller reply and forward button click
            ...
            // controller inbox listing
            $('.inbox-nav > li.inbox > a').click(function () {
                loadInbox('inbox');
            });

            // controller sent listing
            $('.inbox-nav > li.sent > a').click(function () {
                loadInbox('sent');
            });

            // controller draft listing
            $('.inbox-nav > li.draft > a').click(function () {
                loadInbox('draft');
            });

            // controller trash listing
            $('.inbox-nav > li.trash > a').click(function () {
                loadInbox('trash');
            });

            //controller compose/reply cc input toggle
            $('.inbox-compose .mail-to .inbox-cc').live('click', function () {
                handleCCInput();
            });

            //controller compose/reply bcc input toggle
            $('.inbox-compose .mail-to .inbox-bcc').live('click', function () {
                handleBCCInput();
            });

            //controller loading content based on URL parameter
