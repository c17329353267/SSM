...
/*global define, window, documentmanage, File, Blob, FormData, location */
...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', {
        ...
        options: {
            // The drop target element(s), by the default the complete documentmanage.
            // Set to null to disable drag & drop support:
            dropZone: $(document),
            // The paste target element(s), by the default the complete documentmanage.
