...
public class PagerTag extends SimpleTagSupport {
	...
	public void doTag() throws JspException, IOException {
		...
		if (recordCount > 0){   //1499 / 15  = 100
			...
			res.append("   documentmanage.getElementById('pager_jump_btn').onclick = function(){");
			res.append("      var page_size = documentmanage.getElementById('pager_jump_page_size').value;");
