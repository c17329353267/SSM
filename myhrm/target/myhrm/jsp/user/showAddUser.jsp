...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/addUser.do" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
						<td>
							<span style="padding-top: 5px"><font color="red">${addNews}</font></span>
						</td>
					</tr>
		    	</table>
		    </td></tr>
			...
			<tr><td align="left" class="fftd"><input type="submit" value="添加">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="javascript:history.go(-1);location.reload()"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
