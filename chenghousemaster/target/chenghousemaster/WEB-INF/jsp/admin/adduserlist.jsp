...
<div class="sidebar-title">
        <form action="${pageContext.request.contextPath}/addNewUser.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text required"  name="password" size="50" type="text"></td>>
                                ...
                                <tr>
                                    ...
                                    <%-- <td><textarea class="common-text" name="content"  id="content" style="width:430px;height:80px;">${schedule.content}</textarea></td>--%>
                                   <%-- <td><input class="common-text required"  name="type" size="50" type="text"></td>>--%>
