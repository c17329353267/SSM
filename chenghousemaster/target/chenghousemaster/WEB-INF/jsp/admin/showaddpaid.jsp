								...
								<c:forEach items="${zulist}" var="zulist">
									...
									<tr
										...
										<td><a class="link-update"
											href="${pageContext.request.contextPath}/paid/addpaid.action?id=${zulist.zid }">收租</a>
											&nbsp;&nbsp; 
								...
								<div>
									...
									<c:if test="${ p.pageNum < p.pages }">
									 ...
									 <cheng:pager pageIndex="${pageModel.pageIndex}"
												  ...
												  submitUrl="${pageContext.request.contextPath}/paid/showaddpaid.action?pageIndex={0}"></cheng:pager>
