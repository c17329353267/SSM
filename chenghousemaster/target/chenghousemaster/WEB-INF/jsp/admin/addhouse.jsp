...
.error {
  ...
  color: red;
    ...
    $().ready(function() {
        ...
        function checkchouseid() {
            $.post("${pageContext.request.contextPath}/findAllHoustByid.action?houseid="+$("#houseid").val(),
                function (data) {
                    if(data == "EXIT"){
                        alert("填写的房屋id已经存在!！");
        ...
        <form action="${pageContext.request.contextPath}/addhouse.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                                ...
                                <td>
                                    <input class="common-text required" value="${houselist.houseid}" id="houseid"
                                           name="houseid" size="50" type="text" onkeyup="checkchouseid();">
                                </td>
